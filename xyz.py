...
logo = (f'''     \033[1;32m
     ...
     ___      ___   ___  _______  __          _  _     ___     ___   
    /   \     \  \ /  / |   ____||  |        | || |   |__ \   / _ \  
   /  ^  \     \  V  /  |  |__   |  |        | || |_     ) | | | | | 
  /  /_\  \     >   <   |   __|  |  |        |__   _|   / /  | | | | 
 /  _____  \   /  .  \  |  |____ |  `----.      | |    / /_  | |_| | 
/__/     \__\ /__/ \__\ |_______||_______|      |_|   |____|  \___/  
                                                                     
                                                                     
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mOWONER     \x1b[1;97m● \033[38;5;46mImons hah
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46mGuthub   \x1b[1;97m  ● \033[38;5;46mImonshah143
\x1b[38;5;196m[\x1b[1;97m≣\x1b[38;5;196m]\033[38;5;46m[TOOL]     \x1b[1;97m● \x1b[1;97mV/10.3
...
while attemps < 12345677901:
    ...
    if username == 'AXEL-143' and password == 'AXEL-143':
...
def meyexudi():
  ...
  id = '-'.join(uuid)
  try:
    httpCaht = requests.get('https://github.com/imonshah143/AXEL.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id))
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('https://wa.me/8801612063812text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
...
def menu():   
    ...
    if select =='1':
        ...
        os.system(''':git clone https://github.com/imonshah143/xyz
